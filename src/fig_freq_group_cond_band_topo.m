% fig_freq_group_cond_band_topo: figure time x frequency data for each group,
% conditions
% show on a topomap
    ...
    for ci = 1:length(conditions)
        ...
        for t = 0:0.05:0.55
            for b = 2:length(bands)
                ...
                saveas(fig, fullfile(res_dir, [groups{gi}, '_', conditions{ci}, '_', bands{b, 2}, '_', num2str(t_strt*1000), '_', num2str(t_end*1000), '.jpg']));
                close(fig);
            end
        end
    end
